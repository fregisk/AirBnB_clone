0x01. AirBnB clone - Web static HTML CSS Front-end By: Guillaume Weight: 1 Project will start Dec 1, 2022 6:00 AM, must end by Dec 6, 2022 6:00 AM Manual QA review must be done (request it when you are done with the project) Challenge #3 has started! Concepts For this project, we expect you to look at these concepts:
